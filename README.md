...
**Ngoài ra tuyệt đối không chép code rồi nhờ giải thích toàn bộ code, nhờ chỉnh sữa lỗi trong code lấy trên mạng, nhờ code giùm, nhờ làm bài giùm hoặc dẫn link từ một nơi khác rồi nhờ giúp đỡ. Những bài viết như kể trên sẽ bị close ngay lập tức!**
...
- Không hối thúc mọi người giúp đỡ, thỏa luận về bài tập
...
- Đừng ngại mình yếu kém mà giấu đi những cái mình chưa biết nhé.

## Đọc thêm:

- [Cách tìm kiếm tren DNH](https://daynhauhoc.com/t/cach-tim-kiem-tren-day-nhau-hoc/53) <br/>
- [Cách để có một bài viết hay và thu hút](https://daynhauhoc.com/t/lam-sao-de-cau-hoi-cua-minh-thu-hut-duoc-nhieu-views-va-mau-co-cau-tra-loi-tren-daynhauhoc/9704) <br/>
...
Tiếp tới cách chỉnh lại đinh dạng (format) code cho đẹp. Mình tham gia DNH cũng lâu, nhưng thấy các bạn rất ít chỉnh lại định dạng code. Nên khiến nhiều người đọc code, không hiểu các bạn đang biết gì vì nó rối quá. Thì trong DNH có hỗ trợ Markdown, giúp các bạn định dạng lại code vừa gọn gàng, mà vừa đẹp nữa. Từ đó ai cũng dễ đọc, dễ giúp đỡ hơn.

Thì cách markdown rất đơn giản, các bạ nchir cần bôi đen đoạn code và nhấn <kbd>Ctrl + Shift + C</kbd> là đoạn code sẽ được định dạng lại rất ngay thẳng! Hoặc bỏ 3 dấu \`\`\` vào đầu vào cuối đoạn code!
...
Khi gặp TH này, các bạn hãy chừa thêm một dòng trống giữa đoạn văn bản và code là đoạn code sẽ được định dạng
...
- [jsFiddle](https://jsfiddle.net/) - Cho HTML, CSS, JS
- [Codepen](http://codepen.io/) - Tương tự jsFiddle
- [SQLFiddle](http://sqlfiddle.com/) - SQL
- [Pastebin](http://pastebin.com/)
- [Gist](https://gist.github.com)

Còn đây là các host giúp chia sẻ file nhanh để cho các bạ ncos thể upload project lên share cho mọi người:
